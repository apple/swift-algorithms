...
- [`prefixPadded(with:toCount:)`, `suffixPadded(with:toCount:)`](https://github.com/apple/swift-algorithms/blob/main/Guides/Padded.md): Pads a collection to the specified length using the provided padding element.
